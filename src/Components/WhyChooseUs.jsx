      ...
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12'>
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className='group text-center bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-blue-400/30 transition-all duration-500 transform hover:scale-105 hover:-translate-y-4'>
                {/* Icon Container */}
                <div className='mb-8'>
                  <div className='w-24 h-24 bg-gray-700 rounded-full flex items-center justify-center mx-auto group-hover:bg-blue-500 transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-6 border-4 border-white/20 group-hover:border-blue-400/50'>
                    <IconComponent
                      size={40}
        ...
        <div className='text-center mt-16 bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10'>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-6'>
            ...
            <button className='group text-blue-400 hover:text-blue-300 font-semibold text-lg transition-all duration-300 flex items-center gap-2'>
              Learn More
              <span className='transform group-hover:translate-x-1 transition-transform duration-300'>
                →
              </span>
