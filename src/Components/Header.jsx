...
//                   <Phone
//                     size={18}
//                     className='group-hover:scale-110 transition-transform duration-200 to-blue-600'
//                   />
  ...
  return (
    <>
      <div
        ...
        <div className='max-w-7xl mx-auto px-4 py-5 flex items-center justify-between'>
          ...
          <div className='mobile-menu-container'>
            <button
              ...
              className='md:hidden focus:outline-none p-2 rounded-lg transition-colors z-60'
              style={{
                color: "#fff",
                backgroundColor: menuOpen ? "#e0e7ef" : "transparent",
              }}
        ...
        {menuOpen && (
          <>
            {/* Backdrop - moved before menu and lower z-index */}
            <div
              className='fixed inset-0 bg-black bg-opacity-50 z-40 md:hidden'
              onClick={() => setMenuOpen(false)}
            />
            {/* Mobile Menu Content - higher z-index to appear above backdrop */}
            <div
              className='mobile-menu-container md:hidden shadow-xl px-4 py-4 space-y-3 max-h-[70vh] overflow-y-auto relative z-50'
              style={{
