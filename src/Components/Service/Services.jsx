...
//                       {/* Background Accent */}
//                       <div
//                         className={`absolute top-0 left-0 w-2 h-full bg-${service.accentColor}-500 transform scale-y-0 group-hover:scale-y-100 transition-all duration-500 origin-top`}></div>
...
//                         {/* Action Button */}
//                         <button
//                           className={`bg-${service.accentColor}-600 hover:bg-${service.accentColor}-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center gap-2 group/btn`}>
//                           Learn More
//                           <ArrowRight
//                             size={18}
