...
//       <Herocard
//         heading='SERVICES'
//         description='Discover the diverse range of services we offer — from world-class travel experiences and stylish fashion to cutting-edge IT solutions and trusted education consultancy. We help elevate every aspect of your journey.'
//         image='https://plus.unsplash.com/premium_photo-1682716270464-9a91cbbcf3b7?w=600&auto=format&fit=crop&q=60'
//       />
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div
            ...
            <div className='text-center mb-8 sm:mb-12 md:mb-16'>
              ...
              <p
                className='text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-10 md:mb-12 px-4'
                style={{ color: "#64748b" }}>
                From travel experiences to digital solutions, we provide
                end-to-end services that drive growth and deliver exceptional
                value across multiple industries.
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto px-4'>
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className='bg-white p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105 border border-gray-100'
                      style={{ transitionDelay: `${index * 100}ms` }}>
                      <div
                        className={`w-10 h-10 sm:w-12 sm:h-12 ${stat.bgColor} rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-all duration-500 transform hover:scale-110`}>
                        <IconComponent
                          size={20}
                          className={`sm:w-6 sm:h-6 ${stat.iconColor}`}
                        />
                      </div>
                      <div
                ...
                <div
                  ...
                  <div
                    ...
                    <div
                      className={`${
                        !isEven ? "lg:col-start-2" : ""
                      } relative group order-1 lg:order-none`}>
                      <div className='overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform group-hover:scale-[1.02]'>
                        <img
                          src={service.image}
                          alt={service.title}
                          className='w-full h-48 sm:h-64 md:h-80 object-cover transition-all duration-700 group-hover:scale-110'
                        />
                        <div className='absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500'></div>
                      </div>
                      ...
                      {/* Floating Icon */}
                      <div
                        className={`absolute -top-4 -right-4 sm:-top-6 sm:-right-6 w-12 h-12 sm:w-16 sm:h-16 ${service.bgColor} rounded-2xl shadow-xl flex items-center justify-center transform rotate-6 group-hover:rotate-12 transition-all duration-500`}>
                        <IconComponent
                          size={20}
                          className={`sm:w-7 sm:h-7 ${service.iconColor}`}
                        />
                      </div>
                    </div>
                    ...
                    <div
                      className={`${
                        !isEven ? "lg:col-start-1 lg:row-start-1" : ""
                      } bg-white p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-100 relative overflow-hidden group order-2 lg:order-none`}>
                      {/* Background Accent - Fixed with mapped styles */}
                      <div
                        className={`absolute top-0 left-0 w-2 h-full ${
                          accentStyles[service.accentColor]
                      ...
                      <div className='relative z-10'>
                        <div className='flex items-center mb-4 sm:mb-6'>
                          <div
                            className={`w-10 h-10 sm:w-12 sm:h-12 ${service.bgColor} rounded-xl flex items-center justify-center mr-3 sm:mr-4 transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-6`}>
                            <IconComponent
                              size={20}
                              className={`sm:w-6 sm:h-6 ${service.iconColor}`}
                            />
                          </div>
                          <h3
                        ...
                        <p
                          className='text-sm sm:text-base md:text-lg leading-relaxed mb-6 sm:mb-8 transition-all duration-300'
                          style={{ color: "#64748b" }}>
                          {service.description}
                        </p>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-6 sm:mb-8'>
                          {service.features.map((feature, featureIndex) => (
                            <div
                              ...
                              <ChevronRight
                                size={14}
                                className={`sm:w-4 sm:h-4 ${service.iconColor} transition-all duration-300 group-hover/feature:translate-x-1 flex-shrink-0`}
                              />
                              <span
                        ...
                        <Link to={service.Link} className='inline-block'>
                          <button
                            className={`${
                              buttonStyles[service.accentColor]
                            } text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center gap-2 group/btn text-sm sm:text-base`}>
                            Learn More
                            <ArrowRight
                              size={16}
                              className='sm:w-[18px] sm:h-[18px] group-hover/btn:translate-x-1 transition-transform duration-300'
                            />
                          </button>
                        </Link>
                      </div>
      ...
      <section
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div
            ...
            <div className='bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl p-6 sm:p-8 md:p-12 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-[1.02] relative overflow-hidden'>
              {/* Background decoration */}
              <div className='absolute inset-0 bg-gradient-to-r from-blue-600/20 to-purple-700/20 backdrop-blur-sm'></div>
              ...
              <div className='relative z-10'>
                ...
                <p className='text-sm sm:text-base md:text-lg lg:text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-8 px-4'>
                  Let's discuss how our comprehensive services can help you
                  achieve your goals and drive your success forward.
                </p>

                <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4'>
                  <button className='w-full sm:w-auto bg-white text-blue-600 hover:bg-blue-50 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2 group text-sm sm:text-base'>
                    Contact Us Today
                    <ArrowRight
                      size={18}
                  ...
                  <button className='w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 text-sm sm:text-base'>
                    View Portfolio
                  </button>
                </div>
              </div>
