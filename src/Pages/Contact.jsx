...
const Contact = () => {
  ...
  return (
    <section className='relative py-20 overflow-hidden bg-gray-50 mt-2'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6 lg:px-8'>
        ...
        {/* Success Message */}
        {isSubmitted && (
          <div className='fixed top-20 left-1/2 -translate-x-1/2 z-50 bg-green-500/90 backdrop-blur-lg text-white px-6 py-4 rounded-xl shadow-lg border border-green-400/30 animate-bounce'>
            <div className='flex items-center gap-2'>
              <CheckCircle size={20} />
              <span className='font-semibold'>Message sent successfully!</span>
            </div>
        ...
        <div className='grid lg:grid-cols-2 gap-12'>
            ...
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300'>
              ...
              <div className='space-y-6'>
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 rounded-lg border ${
                          formErrors[field.name]
                            ? "border-red-500"
                            : "border-gray-200"
                        } focus:border-blue-600 focus:ring-2 focus:ring-blue-600 focus:ring-opacity-20 transition-all duration-300`}
                      />
                      {formErrors[field.name] && (
                        <p className='mt-1 text-sm text-red-500'>
                          {formErrors[field.name]}
                ...
                <button
                  onClick={handleSubmit}
                  disabled={isSubmitting}
                  className='w-full py-3 px-6 rounded-lg bg-blue-600 text-white font-semibold flex items-center justify-center gap-2 hover:bg-blue-700 active:scale-95 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed'>
                  {isSubmitting ? (
                    "Sending..."
                  ) : (
                    <>
          ...
          <div
            ...
            {/* Map */}
            <div className='bg-white p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden'>
              <iframe
                title='location'
                src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56516.27776848728!2d85.29111321259504!3d27.709031933406965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb198a307baabf%3A0xb5137c1bf18db1ea!2sKathmandu%2044600!5e0!3m2!1sen!2snp!4v1695925128811!5m2!1sen!2snp'
